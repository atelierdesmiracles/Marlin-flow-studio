...
export const agentApi = {
  ...
  configurationOptions: () => request("/api/configuration/options", { timeout: 30000 }),
  ...
  applyConfiguration: (files, expected_hashes = {}) => request("/api/configuration/apply", { method: "POST", timeout: 30000, body: JSON.stringify({ files, expected_hashes }) }),
  ...
  configurationsBranches: () => request("/api/configurations/branches", { timeout: 30000 }),
  configurationsSuggest: (version) => request(`/api/configurations/suggest?version=${encodeURIComponent(version || "")}`, { timeout: 30000 }),
  configurationsExamples: (ref = "import-2.1.x", path = "config/examples") => request(`/api/configurations/examples?ref=${encodeURIComponent(ref)}&path=${encodeURIComponent(path)}`, { timeout: 30000 }),
  configurationsExample: (ref, path) => request(`/api/configurations/example?ref=${encodeURIComponent(ref)}&path=${encodeURIComponent(path)}`, { timeout: 30000 }),
  configurationsFile: (ref, path) => request(`/api/configurations/file?ref=${encodeURIComponent(ref)}&path=${encodeURIComponent(path)}`, { timeout: 30000 }),
